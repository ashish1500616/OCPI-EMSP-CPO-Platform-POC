...
class OCPIMenuSystem:
    ...
    async def show_configuration(self):
        ...
        print("   • EMSP Token A: emsp_token_a_12345")
        print("   • CPO Token C: cpo_token_c_abcdef")

        print("\n📁 Key Files:")
        print("   • Main App: main.py")
        print("   • Mock CPO: tests/mock_cpo_server.py")
        print("   • Tests: tests/")
        print("   • Reports: tests/reports/")
