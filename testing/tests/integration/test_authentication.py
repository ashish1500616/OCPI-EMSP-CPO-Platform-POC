...
class TestOCPIAuthentication: 
    ...
    async def test_credentials_exchange_flow(self, async_emsp_client, async_mock_cpo_client, 
                                           emsp_auth_headers, cpo_auth_headers):
    ...
    async def test_version_information_exchange(self, async_emsp_client, async_mock_cpo_client,
                                              emsp_auth_headers, cpo_auth_headers):
        """Test version information exchange between EMSP and CPO."""
        # Test EMSP version endpoint
        emsp_versions_response = await async_emsp_client.get(
            "/ocpi/emsp/2.2.1/versions",
            headers=emsp_auth_headers
        )
        ...
        cpo_versions_response = await async_mock_cpo_client.get(
            "/ocpi/cpo/2.2.1/versions",
            headers=cpo_auth_headers
        )
    ...
    async def test_version_details_exchange(self, async_emsp_client, async_mock_cpo_client,
                                          emsp_auth_headers, cpo_auth_headers):
